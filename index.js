...
function addBotVolumeHotkeys(instance) {
  ...
  function common() {
    ...
    instance.setLocalVolume("184405311681986560", volume)
    instance.setLocalVolume("234395307759108106", volume)
    instance.setLocalVolume("235088799074484224", volume)
    instance.setLocalVolume("721772274830540833", volume)
    console.log(volume)
  }
